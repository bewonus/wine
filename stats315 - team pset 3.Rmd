...
The simplest model used lasso regularization and achieved a decent MSE (.544),
...
From this, we concluded that local models using compex interactions would give the best results for this dataset. 
