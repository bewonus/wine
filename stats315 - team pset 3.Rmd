...
\section*{1. Exploring the data with simple models}
...
\section*{2. Exploring feature spaces for penalized regression-based models}
...
\section*{3. Regularization, cross-validation, and evaluation of our regression-based models}
...
\section*{4. More complicated models}
...
\section*{Final Training and Prediction}
...
# note: this has been commented out due to timeout
